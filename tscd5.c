...
void colorchar(FILE * out, uint8_t c)
{
	
		if ( c == 0x0 )
		{
			fprintf(out,"\e[38;5;244m");
		}

		else if ( isalpha(c) )
		{
			
			fprintf(out,"\e[38;5;208m");
		...
		{
			fprintf(out,"\e[38;5;226m");
		}	
	
		else if ( !isprint(c) )
		{
			fprintf(out,"\e[38;5;196m");
		}

		else if ( isspace(c) )
		{
			fprintf(out,"\e[38;5;40m");
		}

		else if ( ispunct(c) )
		{
//			fprintf(out,"\e[38;5;164m");
			
			fprintf(out,"\e[38;5;201m");
		}
...
#endif	
		if ( i == 0 )
		{ colorchar(out,c); fprintf(out,"%08x:%c",i,0x20); resetcolor(out); }
